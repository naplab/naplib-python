...
def test_cat_feats_and_con_feats_overlap_names_error(data2):
    ...
    with pytest.raises(ValueError) as err:
        _ = ttest(x, cat_feats={'groups': groups}, con_feats={'groups': np.concatenate([behavior, behavior], axis=0)})
